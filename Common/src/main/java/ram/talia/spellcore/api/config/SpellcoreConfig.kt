package ram.talia.spellcore.api.config

import net.minecraft.resources.ResourceLocation
import ram.talia.spellcore.api.SpellcoreAPI

object SpellcoreConfig {
    ...
    var common: CommonConfigAccess = DummyCommon
        set(access) {
            if (field != DummyCommon) {
                SpellcoreAPI.LOGGER.warn("CommonConfigAccess was replaced! Old {} New {}",
    ...
    var client: ClientConfigAccess = DummyClient
        set(access) {
            if (field != DummyClient) {
                SpellcoreAPI.LOGGER.warn("ClientConfigAccess was replaced! Old {} New {}",
                        field.javaClass.name, access.javaClass.name)
            }
            field = access
        }
    ...
    var server: ServerConfigAccess = DummyServer
        set(access) {
            if (field != DummyServer) {
                SpellcoreAPI.LOGGER.warn("ServerConfigAccess was replaced! Old {} New {}",
                        field.javaClass.name, access.javaClass.name)
            }
            field = access
        }
